...
$monday = $week[0];
//changed index of week to "0" in order to display the first string
echo $monday;
...
// add if statement after array_push() OR change the 'z' inside the for loop to 'aa'
...
//wrote echo in front of each $login
...
// wrote echo in front of each isLinkValid...
//invalid link
